...
public class InterfaceDoProjeto extends JFrame {
    ...
    public InterfaceDoProjeto() {
        super("Calculando Cargas em Capacitores");
        setDefaultCloseOperation(JFrame.EXIT_ON_CLOSE);
        setLayout(new BorderLayout(10, 10));

        JPanel painelCircuito = new JPanel(new BorderLayout(10, 10));
        painelCircuito.setBorder(BorderFactory.createEmptyBorder(10, 10, 10, 10));

        labelCircuito = new JLabel("Imagem do circuito:");
        labelCircuito.setHorizontalAlignment(JLabel.CENTER);
        painelCircuito.add(labelCircuito, BorderLayout.NORTH);
        ...
        painelCircuito.add(labelImagem, BorderLayout.CENTER);

        add(painelCircuito, BorderLayout.NORTH);

        painelCentro = new JPanel(new GridLayout(3, 2, 10, 10));
        painelCentro.setBorder(new EmptyBorder(20, 40, 20, 40));

        labelDiferencaPotencial = new JLabel("Digite a diferença de potencial U (em Volts): ");
        painelCentro.add(labelDiferencaPotencial);

        textDiferencaPotencial = new JTextField(10);
        ...
        textCapacitancia = new JTextField(10);
        ...
        textResultado.setFont(new Font("Monospaced", Font.PLAIN, 14));
        ...
        botaoResetar.addActionListener(e -> {
            textDiferencaPotencial.setText("");
            textCapacitancia.setText("");
